...
export default function DeleteEmployeeDialog({ isOpen, onOpenChange, onConfirm, employeeName }: DeleteEmployeeDialogProps) {
  return (
      ...
      <AlertDialogContent className="sm:max-w-md rounded-2xl">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="pt-4 text-base text-foreground">
            ¿Está seguro que desea eliminar al empleado <span className="font-bold">{employeeName}</span>? 
            <br/><br/>
