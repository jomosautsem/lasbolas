...
export default function DeleteRateDialog({ isOpen, onOpenChange, onConfirm, rateName }: DeleteRateDialogProps) {
  return (
      ...
      <AlertDialogContent className="sm:max-w-md rounded-2xl">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="pt-4 text-base text-foreground">
            ¿Está seguro que desea eliminar la tarifa <span className="font-bold">{rateName}</span>? 
            <br/><br/>
